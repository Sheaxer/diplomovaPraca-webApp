...
interface NomenclatorKeyService
{
    ...
    public function getNomenklatorKeysByAttributes(?array $userInfo, $limit, $page, ?array $folders = null, ?array $structures = null, bool $myKeys = false, ?string $state = null, ?int $createdBy = null, ?string $orderBy = null, ?string $order = null): ?array;
